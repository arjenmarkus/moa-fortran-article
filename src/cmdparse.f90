...
module cmdparse
    ...
    type :: cmdparser
        ...
        integer(kind=int64), dimension(maxargs)      :: int_arg
    ...
    contains
        ...
        generic   :: get_arg    => get_char, get_int, get_real, get_int64
        procedure :: get_char   => get_char_arg
        procedure :: get_int    => get_int_arg
        procedure :: get_int64  => get_int64_arg
...
subroutine commands_parser( cmdp, template )
    ...
    character(len=*), dimension(:) :: template
...
!     intvalue            Integer value of the argument
!
subroutine get_int64_arg( cmdp, n, intvalue )
    class(cmdparser), intent(inout)  :: cmdp
    integer, intent(in)              :: n
    integer(kind=int64), intent(out) :: intvalue
